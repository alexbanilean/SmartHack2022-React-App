  ...
  return (
    <div className='ckmint__what section__padding' id='#what'>
      <div className='ckmint_what-feature'>
        <Feature title="What is CryptoMint" text="We are avid enjoyers of the crypto market and the blockchain who want to introduce more people to this new and exciting world"/>
      </div>
